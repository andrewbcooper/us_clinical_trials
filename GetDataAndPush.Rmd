...
#board <- board_connect(auth = "rsconnect")
#board %>% pin_write(finaldata,"ClinicalTrialsData")
...
#rsconnect::setAccountInfo(name='schdatascience',
#                          token=token,
 #                         secret=secret,
  #                        server="shinyapps.io")

#rsconnect::deployApp(appFiles=c("clinicaltrials_USA.R","trials","www/logo.jpg"),launch.browser = FALSE,appMode = #"shiny",appPrimaryDoc="clinicaltrials_USA.R",quarto=FALSE,forceUpdate = TRUE)
